...
public class MyTest {
    ...
    public void test2()
    {
        System.out.println(Thread.currentThread().getContextClassLoader().getResource("test.txt"));
        System.out.println(MyTest.class.getClassLoader().getResource("test.txt"));
        System.out.println(ClassLoader.getSystemResource("test.txt"));
        System.out.println(MyTest.class.getResource("/test.txt"));
